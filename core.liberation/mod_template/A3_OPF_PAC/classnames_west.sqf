...
infantry_units_west = [
	...
	["O_T_soldier_F",1,0,0,0],
	["O_T_medic_F",1,0,0,0],
	["O_T_engineer_F",1,0,0,0],
	["O_T_soldier_GL_F",1,0,0,GRLIB_perm_inf],
	["O_T_soldier_M_F",1,0,0,GRLIB_perm_inf],
	["O_T_soldier_LAT_F",1,0,0,0],
	["O_HeavyGunner_F",1,0,0,GRLIB_perm_inf],
	["O_T_recon_F",1,0,0,GRLIB_perm_log],
	["O_T_diver_F",1,0,0,GRLIB_perm_log],
	["O_T_recon_LAT_F",1,0,0,GRLIB_perm_log],
	["O_T_soldier_AA_F",1,0,0,GRLIB_perm_log],
	["O_T_soldier_AT_F",1,0,0,GRLIB_perm_log],
	["O_T_sniper_F",1,0,0,GRLIB_perm_log],
	["O_T_soldier_PG_F",1,0,0,GRLIB_perm_log],
...
light_vehicles = [
	...
	["O_T_Boat_Transport_01_F",1,5,1,0],
