...
F_findFlatPlace = compileFinal preprocessFileLineNumbers "scripts\shared\functions\F_findFlatPlace.sqf";
...
F_getNearestTransport = compileFinal preprocessFileLineNumbers "scripts\shared\functions\F_getNearestTransport.sqf";
F_getNextSector = compileFinal preprocessFileLineNumbers "scripts\shared\functions\F_getNextSector.sqf";
F_getObjectPrice = compileFinal preprocessFileLineNumbers "scripts\shared\functions\F_getObjectPrice.sqf";
...
F_getVehicleMaxLoad = compileFinal preprocessFileLineNumbers "scripts\shared\functions\F_getVehicleMaxLoad.sqf";
...
F_setUnitSkill = compileFinal preprocessFileLineNumbers "scripts\shared\functions\F_setUnitSkill.sqf";
...
F_unitSemiWounded = compileFinal preprocessFileLineNumbers "scripts\shared\functions\F_unitSemiWounded.sqf";
